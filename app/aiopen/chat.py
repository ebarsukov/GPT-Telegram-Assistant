...
OPENAI_CHAT_LIFETIME_SEC = conf.environment.OPENAI_CHAT_LIFETIME_SEC
OPENAI_TEMPERATURE = conf.environment.OPENAI_TEMPERATURE
OPENAI_MAX_TOKENS = conf.environment.OPENAI_MAX_TOKENS
